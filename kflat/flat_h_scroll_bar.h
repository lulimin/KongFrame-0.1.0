...
#ifndef __FLAT_H_SCROLL_BAR_H
#define __FLAT_H_SCROLL_BAR_H
...
class FlatHScrollBar : public FlatWidget
{
public:
	FlatHScrollBar();
	virtual ~FlatHScrollBar();
	...
	uniqid_t GetLeftButtonID() const;
	uniqid_t GetRightButtonID() const;
...
private:
	FlatButton* m_pLeftButton;
	FlatButton* m_pRightButton;
